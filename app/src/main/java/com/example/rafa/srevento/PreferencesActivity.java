...
public class PreferencesActivity extends AppCompatPreferenceActivity {
    ...
    SharedPreferences.OnSharedPreferenceChangeListener spChanged = new
            SharedPreferences.OnSharedPreferenceChangeListener() {
                ...
                public void onSharedPreferenceChanged(SharedPreferences sharedPreferences,
                    ...
                    if(key.equals("idioma_list")) {
                        new AlertDialog.Builder(myContext)
                                .setTitle(R.string.pref_alerta_titulo)
                                .setMessage(R.string.pref_alerta_content)
    ...
    protected void onStart() {
        MyLog.e("tag", "On start...");
        super.onStart();
    }

    @Override
    protected void onResume() {
        MyLog.e("tag", "On resume...");
        super.onResume();
    }

    @Override
    protected void onPause() {
        MyLog.e("tag", "On pause...");
        super.onPause();
    }
    ...
    protected void onRestart() {
        MyLog.e("tag", "On restart...");
        super.onRestart();
    }

    @Override
    protected void onDestroy() {
        MyLog.e("tag", "On destroy...");
        super.onDestroy();
    }
}
